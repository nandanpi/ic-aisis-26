        ...
        <div className="relative z-10 px-5">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-blue-100 mb-8 max-w-3xl mx-auto leading-relaxed">
              ...
              submitting your full paper for IC-AISIS 2027.
            </p>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-4xl mx-auto px-5">
          ...
          <div className="bg-gradient-to-r from-blue-600 to-blue-700 rounded-2xl p-8 text-white text-center shadow-xl">
            ...
            <button
              className="bg-gray-300 text-gray-600 px-8 py-4 rounded-xl font-semibold cursor-not-allowed inline-flex items-center shadow-none"
              disabled
            >
              ...
              <div>
                ...
                <div className="mt-4 p-4 bg-yellow-50 rounded-xl border border-yellow-200">
                  ...
                  <p className="text-yellow-900 text-sm mt-2 leading-relaxed">
                    Proceedings will be published, and Scopus indexing is expected around late November 2027. All accepted papers will be forwarded for publication; however, final indexing/publication decisions rest with the publisher, and acceptance is not guaranteed.
                  </p>
                </div>
              </div>
            </div>
