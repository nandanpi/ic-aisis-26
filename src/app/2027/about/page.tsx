...
const AboutContent = () => {
  ...
  const handleTabChange = (tabId: string) => {
    setActiveTab(tabId);
    router.push(`/2027/about?tab=${tabId}`, { scroll: false });
  };
  return (
    <div className="pt-16">
        ...
        <div className="relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-4xl lg:text-5xl font-display font-bold text-white mb-6">
              About <span className="text-blue-200">IC-AISIS 2027</span>
            </h1>
                ...
                content: (
                  <div className="space-y-8 text-justify">
                    <div className="flex flex-col lg:flex-row gap-8 items-center">
                      <div className="lg:w-1/2">
                        ...
                        <p className="text-gray-700 leading-relaxed">
                          Scheduled for <u>(Coming Soon)</u>, at NMAM Institute of
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                        {[
                          ...
                          },
                          {
                            ...
                            desc: <span>Get your research published with <u>(Coming Soon)</u> (Scopus Indexed)</span>,
                          },
                        ].map((item, index) => (
                          <div
                            key={index}
                    ...
                    <div className="text-gray-700 leading-relaxed">
                      ...
                      <p>
                        Through publication opportunities with <u>(Coming Soon)</u> (Scopus Indexed)
                        and active knowledge exchange,
                        IC-AISIS&apos;27 aspires to make a meaningful
                  ...
                  <div className="space-y-8 text-justify">
                    <div className="bg-gradient-to-r from-blue-600 to-blue-800 text-white rounded-2xl p-8 shadow-lg">
                      ...
                      <p className="text-blue-100 leading-relaxed">
                        The central theme of IC-AISIS&apos;27 underscores the
                    ...
                    <div className="text-gray-700 leading-relaxed space-y-6">
                      <div>
                        ...
                        <p className="mb-4">
                          The theme of IC-AISIS&apos;27, &quot;Harnessing AI to
                        ...
                        <p>
                          IC-AISIS&apos;27 seeks not only to advance academic
                        ...
                        <div className="bg-white rounded-xl p-6 border border-blue-200 shadow-sm">
                          <div className="flex flex-col md:flex-row items-start gap-6">
                            ...
                            <div className="flex-1">
                              <p className="text-gray-700 leading-relaxed">
                                IC-AISIS&apos;27 is aligned primarily with{" "}
                    ...
                    {/* <div className="bg-gradient-to-r from-green-600 to-teal-600 text-white rounded-2xl p-8 shadow-lg">
                      ...
                      <p className="text-green-100 leading-relaxed">
                        ...
                        Development Goals, IC-AISIS&apos;27 serves as a catalyst
                      ...
                      <div className="space-y-8 text-justify">
                        <div className="bg-green-50 rounded-xl p-6 border border-green-100">
                          ...
                          <p className="text-gray-700 leading-relaxed">
                            ...
                            supporting IC-AISIS&apos;27, NSRF reflects NMAMIT&apos;s
